...
// ─── Article Page ─────────────────────────────────────
export const articlePageWrapper = "min-h-screen w-full flex flex-col px-6 py-14 max-w-4xl mx-auto";
...
export const articleContent = "text-[#1d1d1f] leading-[1.9] text-[1rem] whitespace-pre-wrap break-words mt-8 flex-1";
